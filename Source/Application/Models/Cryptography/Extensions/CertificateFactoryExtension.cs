...
namespace Application.Models.Cryptography.Extensions
{
	public static class CertificateFactoryExtension
	{
		...
		extension(ICertificateFactory certificateFactory)
		{
			#region Methods

			public IDictionary<string, ICertificate> Create(IAsymmetricAlgorithmRepository asymmetricAlgorithmRepository, ICertificateConstructionHelper certificateConstructionHelper, CertificateConstructionTreeOptions constructionTree)
			{
			...
			public ICertificate Create(IApplicationCertificateStore applicationCertificateStore, IAsymmetricAlgorithmOptions asymmetricAlgorithmOptions, Action<ICertificateOptions> certificateOptionsAction, ushort? lifetime, ILogger logger, ISystemClock systemClock, string templateName)
			{
				ArgumentNullException.ThrowIfNull(certificateFactory);
			...
			public ICertificate CreateClientCertificate(IApplicationCertificateStore applicationCertificateStore, IAsymmetricAlgorithmOptions asymmetricAlgorithmOptions, ICertificate issuer, ushort? lifetime, ILogger logger, string subject, ISystemClock systemClock)
			{
				ArgumentNullException.ThrowIfNull(certificateFactory);
			...
			public ICertificate CreateIntermediateCertificate(IApplicationCertificateStore applicationCertificateStore, IAsymmetricAlgorithmOptions asymmetricAlgorithmOptions, ICertificate issuer, ushort? lifetime, ILogger logger, string subject, ISystemClock systemClock)
			{
				ArgumentNullException.ThrowIfNull(certificateFactory);
			...
			public ICertificate CreateRootCertificate(IApplicationCertificateStore applicationCertificateStore, IAsymmetricAlgorithmOptions asymmetricAlgorithmOptions, ushort? lifetime, ILogger logger, string subject, ISystemClock systemClock)
			{
				ArgumentNullException.ThrowIfNull(certificateFactory);
			...
			public ICertificate CreateTlsCertificate(IApplicationCertificateStore applicationCertificateStore, IAsymmetricAlgorithmOptions asymmetricAlgorithmOptions, IEnumerable<string> dnsNames, ICertificate issuer, ushort? lifetime, ILogger logger, string subject, ISystemClock systemClock)
			{
				ArgumentNullException.ThrowIfNull(certificateFactory);
			...
			private void Populate(IAsymmetricAlgorithmRepository asymmetricAlgorithmRepository, ICertificateConstructionHelper certificateConstructionHelper, CertificateConstructionOptions defaults, CertificateConstructionOptions levelDefaults, IDictionary<string, CertificateConstructionNodeOptions> nodes, IDictionary<string, ICertificate> result, ICertificate issuer = null)
			{
				ArgumentNullException.ThrowIfNull(certificateFactory);
				ArgumentNullException.ThrowIfNull(asymmetricAlgorithmRepository);
				ArgumentNullException.ThrowIfNull(certificateConstructionHelper);
